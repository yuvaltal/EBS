...
--------------------------------------------------------------------
       ...
       ,(select xxssys_oa2sf_util_pkg.get_sf_so_header_id(oola.header_id)  from oe_order_lines_all oola
        where oola.line_id = l1.upg_orig_system_ref_id )    sf_so_order_id--CHG0042873 - CTASK0039732 
